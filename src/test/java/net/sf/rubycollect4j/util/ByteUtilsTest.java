...
public class ByteUtilsTest {
  ...
  public void testToList() {
    RubyArray<Byte> bytes = ByteUtils.toList(new byte[] {(byte) 0x00, (byte) 0x01, (byte) 0x02});
  ...
  public void testToArray() {
    ...
    assertArrayEquals(new byte[] {(byte) 0x00, (byte) 0x01, (byte) 0x02}, ByteUtils.toArray(bytes));
  }
  ...
  public void testLjust() {
    ...
    assertArrayEquals(new byte[] {(byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0x03, (byte) 0x00},
        ByteUtils.ljust(bytes, 5));
  }
  ...
  public void testRjust() {
    ...
    assertArrayEquals(new byte[] {(byte) 0x00, (byte) 0x00, (byte) 0x01, (byte) 0x02, (byte) 0x03},
        ByteUtils.rjust(bytes, 5));
  }
  ...
  public void testReverse() {
    ...
    assertArrayEquals(new byte[] {(byte) 4, (byte) 3, (byte) 2, (byte) 1}, bytes);
  }

  @Test
  public void testToByteArrayWithByte() {
    assertArrayEquals(new byte[] {'\1'}, ByteUtils.toByteArray((byte) '\1'));
    assertArrayEquals(new byte[] {'\1'}, ByteUtils.toByteArray(Byte.valueOf((byte) '\1')));
  }

  @Test
  public void testToByteArrayWithShort() {
    assertArrayEquals(new byte[] {'\1', '\0'}, ByteUtils.toByteArray((short) '\1', le));
    assertArrayEquals(new byte[] {'\1', '\0'},
        ByteUtils.toByteArray(Short.valueOf((short) '\1'), le));
    assertArrayEquals(ByteUtils.toByteArray((short) '\1', be), ByteUtils.toByteArray((short) '\1'));
  ...
  public void testToByteArrayWithInteger() {
    assertArrayEquals(new byte[] {'\1', '\0', '\0', '\0'}, ByteUtils.toByteArray(1, le));
    ...
    assertArrayEquals(ByteUtils.toByteArray(1, be), ByteUtils.toByteArray(Integer.valueOf(1)));
  }
  ...
  public void testToByteArrayWithDouble() {
    assertArrayEquals(new byte[] {'\0', '\0', '\0', '\0', '\0', '\0', (byte) -16, (byte) 63},
        ByteUtils.toByteArray(1d, le));
    assertArrayEquals(new byte[] {'\0', '\0', '\0', '\0', '\0', '\0', (byte) -16, (byte) 63},
        ByteUtils.toByteArray(Double.valueOf(1d), le));
  ...
  public void testToByteArrayWithCharacter() {
    assertArrayEquals(new byte[] {'\1', '\0'}, ByteUtils.toByteArray((char) 1, le));
    assertArrayEquals(new byte[] {'\1', '\0'},
  ...
  public void testToByteArrayWithObject() {
    assertArrayEquals(new byte[] {(byte) 0x41}, ByteUtils.toByteArray("A", le));
    assertArrayEquals(new byte[] {(byte) 0x00}, ByteUtils.toByteArray(Byte.valueOf((byte) 0), le));
    ...
    assertArrayEquals(new byte[] {(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
        (byte) 0x00, (byte) 0x00, (byte) 0x00}, ByteUtils.toByteArray(Long.valueOf(0L), le));
    assertArrayEquals(new byte[] {(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00},
        ByteUtils.toByteArray(Float.valueOf(0f), le));
    assertArrayEquals(new byte[] {(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
        (byte) 0x00, (byte) 0x00, (byte) 0x00}, ByteUtils.toByteArray(Double.valueOf(0d), le));
    assertArrayEquals(new byte[] {(byte) 0x00}, ByteUtils.toByteArray(Boolean.FALSE, le));
    assertArrayEquals(new byte[] {(byte) 0x01}, ByteUtils.toByteArray(Boolean.TRUE, le));
    assertArrayEquals(new byte[] {(byte) 0x00, (byte) 0x00},
  ...
  public void testToExtendedASCIIs() {
    assertEquals("A", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 65}, 1, nativeOrder()));
    assertEquals("\7", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 7}, 1, nativeOrder()));
    assertEquals("\10", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 8}, 1, nativeOrder()));
    assertEquals("\11", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 9}, 1, nativeOrder()));
    assertEquals("\12", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 10}, 1, nativeOrder()));
    assertEquals("\13", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 11}, 1, nativeOrder()));
    assertEquals("\14", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 12}, 1, nativeOrder()));
    assertEquals("\15", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 13}, 1, nativeOrder()));
    assertEquals("\33", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 27}, 1, nativeOrder()));
    assertEquals("\20", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 16}, 1, nativeOrder()));
    assertEquals("A\0", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 65}, 2, LITTLE_ENDIAN));
    assertEquals("\0A", ByteUtils.toExtendedASCIIs(new byte[] {(byte) 65}, 2, BIG_ENDIAN));
    assertEquals("A\177",
        ByteUtils.toExtendedASCIIs(new byte[] {(byte) 65, (byte) 127}, 2, BIG_ENDIAN));
  }

  @Test
  public void testToUTF() {
    assertEquals("A", ByteUtils.toUTF(ByteBuffer.allocate(4).putInt(65).array()));
    assertEquals("\0", ByteUtils.toUTF(ByteBuffer.allocate(4).putInt(0).array()));
    assertEquals("\7", ByteUtils.toUTF(ByteBuffer.allocate(4).putInt(7).array()));
    assertEquals("〹", ByteUtils.toUTF(ByteBuffer.allocate(4).putInt(12345).array()));
    assertEquals("\uD903", ByteUtils.toUTF(ByteBuffer.allocate(4).putInt(55555).array()));
  }
  ...
  public void testToBinaryString() {
    ...
    assertEquals("111001101000100010010001", ByteUtils.toBinaryString("我".getBytes(), true));
    assertEquals("111001101000100010010001", ByteUtils.toBinaryString("我".getBytes()));
    assertEquals("011001110001000110001001", ByteUtils.toBinaryString("我".getBytes(), false));
  }
  ...
  public void testFromHexString() {
    assertArrayEquals(new byte[] {(byte) 0x00, (byte) 0xFF}, ByteUtils.fromHexString("00Ff"));
    assertArrayEquals(new byte[] {(byte) 0x00, (byte) 0xF0}, ByteUtils.fromHexString("00F"));
