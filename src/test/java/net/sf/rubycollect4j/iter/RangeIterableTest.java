...
public class RangeIterableTest {
  ...
  public void setUp() throws Exception {
    iter = new RangeIterable<Integer>(IntegerSuccessor.getInstance(), 1, 3, Interval.CLOSED);
  }
  ...
  public void testConstructorException2() {
    assertThrows(NullPointerException.class, () -> {
      new RangeIterable<Integer>(IntegerSuccessor.getInstance(), null, 3, Interval.CLOSED);
    });
  }
  ...
  public void testConstructorException3() {
    assertThrows(NullPointerException.class, () -> {
      new RangeIterable<Integer>(IntegerSuccessor.getInstance(), 1, null, Interval.CLOSED);
    });
  }
  ...
  public void testClosedOpen() {
    iter = new RangeIterable<Integer>(IntegerSuccessor.getInstance(), 1, 3, Interval.CLOSED_OPEN);
    assertEquals(Ruby.Array.of(1, 2), Ruby.Enumerator.of(iter).toA());
  }

  @Test
  public void testOpen() {
    iter = new RangeIterable<Integer>(IntegerSuccessor.getInstance(), 1, 3, Interval.OPEN);
    assertEquals(Ruby.Array.of(2), Ruby.Enumerator.of(iter).toA());
  }

  @Test
  public void testOpenClosed() {
    iter = new RangeIterable<Integer>(IntegerSuccessor.getInstance(), 1, 3, Interval.OPEN_CLOSED);
