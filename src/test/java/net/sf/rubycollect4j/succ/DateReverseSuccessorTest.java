...
public class DateReverseSuccessorTest {
  ...
  public void testSucc() {
    assertEquals(Ruby.Date.of(2012, 12, 31),
        predecessor.succ(Ruby.Date.of(2013, 1, 1)));
    assertEquals(Ruby.Date.of(2013, 1, 1),
        predecessor.succ(Ruby.Date.of(2013, 1, 2)));
  }

  @Test
  public void testCompareTo() {
    assertEquals(1, predecessor.compare(Ruby.Date.of(2012, 12, 31),
        Ruby.Date.of(2013, 1, 1)));
    assertEquals(0, predecessor.compare(Ruby.Date.of(2013, 1, 1),
        Ruby.Date.of(2013, 1, 1)));
    assertEquals(-1, predecessor.compare(Ruby.Date.of(2013, 1, 2),
        Ruby.Date.of(2013, 1, 1)));
  }
