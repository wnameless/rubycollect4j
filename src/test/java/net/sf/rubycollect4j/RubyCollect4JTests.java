...
import net.sf.rubycollect4j.succ.DateReverseSuccessorTest;
...
import net.sf.rubycollect4j.succ.TemporalSuccessorTest;
...
@SuiteClasses({ RubyTest.class, RubyArrayTest.class, RubyCollectionsTest.class,
    ...
    TemporalSuccessorTest.class, ASCII8BitUTFTest.class, ByteUtilsTest.class,
