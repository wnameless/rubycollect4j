...
/**
 * 
 * {@link DateReverseSuccessor} generates a predecessor of any given Date. It's a singleton object.
 * 
 * @author Wei-Ming Wu
 * 
 */
public final class DateReverseSuccessor implements Successive<Date> {
  ...
  private static final DateReverseSuccessor INSTANCE = new DateReverseSuccessor();
