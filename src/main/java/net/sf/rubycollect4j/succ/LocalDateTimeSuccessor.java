...
/**
 * 
 * {@link LocalDateTimeSuccessor} generates a successor of any given {@link LocalDateTime}. It's a
 * singleton object.
 * 
 * @author Wei-Ming Wu
 * 
...
public class LocalDateTimeSuccessor implements Successive<LocalDateTime> {
  ...
  private static final LocalDateTimeSuccessor INSTANCE = new LocalDateTimeSuccessor();
