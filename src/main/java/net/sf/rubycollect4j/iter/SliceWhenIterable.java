...
/**
 * 
 * {@link SliceWhenIterable} iterates all elements by slicing elements into different parts. It
 * performs each slicing when any element is true returned by the block.
 * 
...
public final class SliceWhenIterable<E> implements Iterable<RubyArray<E>> {
   ...
   */
  public SliceWhenIterable(Iterable<? extends E> iter, BiPredicate<? super E, ? super E> block) {
