...
/**
 * 
 * {@link ChunkWhileIterable} processes elements with given block first, and then puts the original
...
public final class ChunkWhileIterable<E> implements Iterable<RubyArray<E>> {
   ...
   */
  public ChunkWhileIterable(Iterable<? extends E> iter, BiPredicate<? super E, ? super E> block) {
