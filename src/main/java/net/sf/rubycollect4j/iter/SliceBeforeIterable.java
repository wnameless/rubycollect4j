...
/**
 * 
 * {@link SliceBeforeIterable} iterates all elements by slicing elements into different parts. It
...
public final class SliceBeforeIterable<E> implements Iterable<RubyArray<E>> {
   ...
   */
  public SliceBeforeIterable(Iterable<? extends E> iter, Predicate<? super E> block) {
