...
/**
 * {@link TransformIterable} converts any type of Iterable to another type by given
 * {@link Function}.
 * 
...
public class TransformIterable<E, S> implements Iterable<S> {
   ...
   */
  public TransformIterable(Iterable<? extends E> iter, Function<? super E, ? extends S> block) {
