...
/**
 * 
 * {@link DropWhileIterable} drops elements until the returned value of the block is false before
 * iterating elements.
 * 
...
public final class DropWhileIterable<E> implements Iterable<E> {
   ...
   */
  public DropWhileIterable(Iterable<? extends E> iter, Predicate<? super E> block) {
