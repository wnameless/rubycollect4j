...
/**
 * 
 * {@link EachSliceIterator} iterates each element by a window of size n. It returns a RubyArray
 * which includes n consecutive elements within this window, then it moves the position to the very
 * next element behind the window and so on.
 * 
