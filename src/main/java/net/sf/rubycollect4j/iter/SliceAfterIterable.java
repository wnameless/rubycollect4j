...
/**
 * 
 * {@link SliceAfterIterable} iterates all elements by slicing elements into
...
public final class SliceAfterIterable<E> implements Iterable<RubyArray<E>> {
  ...
  public Iterator<RubyArray<E>> iterator() {
    if (block != null)
      return new SliceAfterIterator<E>(iter.iterator(), block);
    else
      return new SliceAfterIterator<E>(iter.iterator(), pattern);
  }
