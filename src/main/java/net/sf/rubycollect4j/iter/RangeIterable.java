...
/**
 * 
 * {@link RangeIterable} iterates each element within a range derived by 2 objects.
 * 
...
public final class RangeIterable<E> implements Iterable<E> {
   ...
   * @throws NullPointerException if successive or startPoint or endPoint is null
   */
  public RangeIterable(Successive<E> successive, E startPoint, E endPoint, Interval interval) {
