...
/**
 * 
 * {@link CombinationIterable} generates all combinations into a List with length n.
 * 
...
public class CombinationIterable<E> implements Iterable<RubyArray<E>> {
  ...
  /**
   * Creates a {@link CombinationIterable}.
   * 
   * @param list a List
   * @param n length of each combination
   * @throws NullPointerException if list is null
   */
  public CombinationIterable(List<? extends E> list, int n) {
