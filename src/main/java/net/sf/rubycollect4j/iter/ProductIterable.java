...
public final class ProductIterable<E> implements Iterable<RubyArray<E>> {
   ...
   * @throws NullPointerException if self or others is null
   */
  public ProductIterable(List<? extends E> self, List<? extends List<? extends E>> others) {
