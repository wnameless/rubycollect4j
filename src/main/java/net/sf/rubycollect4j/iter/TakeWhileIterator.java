...
/**
 * 
 * {@link TakeWhileIterator} iterates over the elements until the returned value by the block is
 * false.
 * 
...
public final class TakeWhileIterator<E> implements Iterator<E> {
   ...
   */
  public TakeWhileIterator(Iterator<? extends E> iter, Predicate<? super E> block) {
