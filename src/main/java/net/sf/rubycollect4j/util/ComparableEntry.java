...
public final class ComparableEntry<K, V>
  ...
  public int compareTo(Entry<? extends K, ? extends V> o) {
    if (o == null) throw new IllegalArgumentException(
        "ArgumentError: comparison of " + entry.getClass().getName() + " with null failed");
    ...
    if (entry.getValue() instanceof Comparable && o.getValue() instanceof Comparable) {
      if ((diff = valueComp.compare(entry.getValue(), o.getValue())) != 0) return diff;
    }
