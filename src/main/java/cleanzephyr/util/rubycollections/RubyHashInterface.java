...
public interface RubyHashInterface<K, V> extends Map<K, V> {
  ...
  public <S> RubyArray<Entry<S, RubyArray<Entry<K, V>>>> chunk(EntryTransformBlock<K, V, S> block);
  ...
  public RubyArray<RubyArray<Entry<K, V>>> sliceBefore(EntryBooleanBlock<K, V> block);
